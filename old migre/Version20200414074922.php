 ...
 */
final class Version20200414074922 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE date_create date_create DATE DEFAULT \'CURRENT_TIMESTAMP\'');
